...
def main() -> None:
    ...
    Portfolio_Daily_returns = (long_only_signal * Daily_futur_returns).rename(
        "Portfolio_Daily_returns"
    )
    random_total_return = total_return(Portfolio_Daily_returns, long_only_signal)
    ...
    print("Daily_futur_returns:")
    print(Daily_futur_returns)
    print()
    print("Portfolio_Daily_returns:")
    print(Portfolio_Daily_returns)
    print()
    print("always-buy daily PnL:")
    print(always_buy_pnl)
    print()

    save_pnl_chart(Portfolio_Daily_returns, always_buy_pnl)
